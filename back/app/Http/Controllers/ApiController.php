...
class ApiController extends Controller
{
     ...
     * Effectue un appel à l'API VTOM et retourne les données au frontend.
     *
     * @return JsonResponse
     */
    public function vtomEnvironments(): JsonResponse
    {
        try {
            ...
            ->withoutVerifying() // Désactive la vérification SSL pour certificats auto-signés
            ->timeout(30)
    ...
    /**
     * Récupère la liste des applications d'un environnement VTOM spécifique.
     *
     * @param string $environment Nom de l'environnement (ex: PAY_TOURS)
     * @return JsonResponse
     */
